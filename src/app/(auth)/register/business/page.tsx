...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		title: t('registerBusinessTitle'),
		description: t('registerBusinessDescription'),
	}
}
...
export default async function RegisterBusinessPage() {
	...
	const brandingParts = t('registerBusinessBrandingTitle', { brand }).split(
		brand,
	)
	...
	return (
		<>
				...
				<div className="relative ml-auto flex h-full max-w-lg flex-col justify-between p-12">
					...
					<div>
						...
						<p className="mt-4 max-w-sm font-sans text-base leading-[1.7] text-muted-foreground">
							{t('registerBusinessBrandingSubtitle')}
						</p>
					</div>
			...
			{/* Right panel — business registration form */}
