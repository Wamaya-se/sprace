		...
		<div className="flex flex-col gap-6">
			...
			<div className="flex flex-col gap-2">
				...
				<Input
					...
					aria-describedby={
						errors.portfolioUrl ? 'portfolioUrl-error' : 'portfolioUrl-hint'
					}
				/>
				{errors.portfolioUrl ? (
					<p
			...
			<div className="flex flex-col gap-3">
				...
				<div className="flex flex-col gap-4">
					<div className="flex items-center gap-3">
						<span
							className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-surface-container-high"
							aria-hidden="true"
						>
							<svg
					...
					<div className="flex items-center gap-3">
						...
						<Input
							...
							type="text"
							value={tiktokHandle}
							onChange={(e) => onFieldChange('tiktokHandle', e.target.value)}
							placeholder={t('tiktokPlaceholder')}
							aria-label={t('tiktokHandle')}
							autoComplete="off"
						/>
					</div>
					...
					<div className="flex items-center gap-3">
						...
						<Input
							...
							type="text"
							value={youtubeHandle}
							onChange={(e) => onFieldChange('youtubeHandle', e.target.value)}
							placeholder={t('youtubePlaceholder')}
							aria-label={t('youtubeHandle')}
							autoComplete="off"
						/>
					</div>
				</div>
