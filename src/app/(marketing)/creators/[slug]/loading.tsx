				...
				<div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
					...
					<div className="flex flex-col gap-10 md:flex-row md:items-start md:gap-16">
						...
						<div className="flex-1 space-y-4">
							<div className="h-10 w-72 animate-pulse rounded-lg bg-foreground/10" />
				...
				<div className="grid gap-12 pt-16 lg:grid-cols-[1fr_340px]">
					<div className="space-y-16">
						...
						<div className="space-y-6">
							<div className="h-7 w-28 animate-pulse rounded bg-foreground/10" />
							<div className="grid gap-4 sm:grid-cols-2">
								<div className="h-52 animate-pulse rounded-xl bg-surface-container" />
								<div className="h-52 animate-pulse rounded-xl bg-surface-container" />
							</div>
						</div>
					</div>
